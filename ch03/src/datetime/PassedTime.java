...
public class PassedTime {
	...
	public static void main(String[] args) {
		...
		Calendar today = Calendar.getInstance();    //종료일 객체 생성
...
//						  theDay.get(Calendar.MONTH) + "월 " +
//						  theDay.get(Calendar.DATE) + "일";
//		
...
//		System.out.println(today1);
	...
	public static String datePrint(Calendar date) {         //날짜 객체를 매게로 전달받아
